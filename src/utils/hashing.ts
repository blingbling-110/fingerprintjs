...
/*
 * 覃子俊添加 2021年6月17日
 * https://github.com/karanlyons/murmurHash3.js/blob/a33d0723127e2e5415056c455f8aed2451ace208/murmurHash3.js
 */
...
//
export function x86hash32(key: string, seed?: number): string {
  key = key || '';
  seed = seed || 0;
